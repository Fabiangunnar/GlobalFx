...
} from "@/components/pages/Modal";
import { getUser, reset } from "@/redux/features/HomeAppSlice";
...
const ProfilePage = (props: Props) => {
  ...
  const { userInfo, usersState, errorMessage } = useAppSelector(
  ...
  return (
    <main className={`${styles.user_block}`}>
      <Card
        color={"#fff"}
        background={"#759c4950"}
        w="100%"
