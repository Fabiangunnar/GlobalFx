    ...
    subheads: [
      {
        id: "LMK26P",
        state: false,
        head: `WHAT IS ${appname} TRADE ?`,
        desc: `${appname} - Professional team of cryptocurrency industry developers. The main advantage of the company is a unique trading bot that makes a profit at the stage of growth and market decline.`,
      },
      {
        id: "QWE72M",
        state: false,
        head: `IS ${appname} the OFFICIALLY REGISTERED COMPANY?`,
  ...
  },
  {
    ...
    subheads: [
      ...
      },
      {
        ...
        desc: `Any person who has reached the age of majority in their country of residence can register in ${appname}`,
      },
      {
        id: "KQR71K",
        state: false,
        ...
        descList: [
          {
            ...
            desc: `Click the Register button. Enter your details to quickly create a FREE ${appname} account.`,
          },
          {
            id: "KLP59Z",
            head: "OPEN A DEPOSIT",
    ...
    subheads: [
      {
        id: "KLP59K",
        state: false,
        head: `WHAT WAYS TO OBTAIN INCOME IN ${appname} ARE?`,
  ...
  },
  {
    ...
    subheads: [
...

      {
        ...
        desc: `Click on the reset password link on the main page of the site in the login section. Enter your email address and follow the instructions. You will receive information on how to reset your ${appname} account password.`,
      },
    ],
  },
];
...
export const stepBoxes = [
  {
    ...
    step: "#1",
    head: "REGISTRATION",
    desc: `Click the Register button. Fill in your details to create a FREE ${appname} account in second`,
  },
  {
    id: "QWE72M",
    step: "#2",
...
export const pifTraders = [
  {
    ...
    desc: `${appname} team of professionals has created a unique trading robot that makes profit at any stage of the market: rise or fall`,
  },
  {
    id: "QWE72M",
...

  {
    ...
    desc: `The highly professional ${appname} team controls all the processes of the trading robot around the clock. After investing, you will observe the growth of your capital in real time`,
  },
];
export const investmentProposals = [
  {
    ...
    percentage: "0.5%",
    desc: `from the received profit by the robot. This commission shows the earnings of the entire ${appname} structure, namely, each employee.`,
  },
  {
    id: "QWE72M",
