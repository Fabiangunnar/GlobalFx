...
import { getAllKYCDocuments } from "@/redux/features/AppSlice";
import { useAppSelector, useAppDispatch } from "@/redux/hooks";

type Props = {};

const Kyc = (props: Props) => {
  const { posts, currentPostsPage, postsPerPage } = useAppSelector(
    (state) => state.mgmt
  );
  const { kycdocuments } = useAppSelector((state) => state.AppSlice);
