...
import { appname, footerData, footerTypes, linkTypes } from "@/data/maindata";
import Link from "next/link";
import styles from "@/app/styles/home/Footer.module.scss";
  ...
  return (
    <div className={`${styles.footer}`}>
      ...
      <div className={`${styles.footer_bottom}`}>
        <div>&copy; Copyright, 2024 {appname}. All Rights Reserved</div>
