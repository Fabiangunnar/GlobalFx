        ...
        <main className={` ${pagestyles.body}`}>
          ...
          >
            ...
            >
              ...
              >
                <Flex direction={"column"} gap={4}>
                  ...
                  >
                    SAFE INVESTMENT WITH <br /> {appname}
                  </Text>
            ...
            >
              ...
              >
                {appname} employees ensure that every investor in our company
                can earn money
              </Text>
              <Card
                w={{
                      ...
                      <CardBody>
                        <Flex direction="column" gap={4}>
                          ...
                          <Text
                            ...
                            fontWeight={100}
                          >
                            These commissions are charged by {appname}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  market behind them. They brought {appname} to the world level
                  of development
                </Text>
              </Flex>
              <Flex
