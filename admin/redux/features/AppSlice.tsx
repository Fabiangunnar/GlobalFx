...
export const deleteDeposit: any = createAsyncThunk(
  "delete/deposit",
  async (id: any, thunkApi) => {
    try {
      return await DeleteDepositApi(id);
    } catch (error: any) {
      return thunkApi.rejectWithValue(error.response.data);
    }
  }
